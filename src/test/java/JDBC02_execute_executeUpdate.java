...
public class JDBC02_execute_executeUpdate {
    ...
    */
        ...
        /*=======================================================================
	      ORNEK8: isciler tablosundan birimi ARGE olan iscileri silelim
	     ========================================================================*/
         String deleteQuery ="DELETE FROM isciler WHERE birim='ARGE'";
        int silinenSatirSayisi= st.executeUpdate(deleteQuery);// Burada sildi
        System.out.println(silinenSatirSayisi + " satir silindi!");

  /*=======================================================================
	      ORNEK 9: isciler tablosunun son durumunu gorelim
	     ========================================================================*/
